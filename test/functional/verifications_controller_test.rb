...
class VerificationsControllerTest < ActionController::TestCase
  ...
  test "should create verification" do
    assert_difference('Verification.count') do
      post :create, verification: { manufacturer_id: @verification.manufacturer_id, retailer_id: @verification.retailer_id, status: @verification.status }
    end
  ...
  test "should update verification" do
    put :update, id: @verification, verification: { manufacturer_id: @verification.manufacturer_id, retailer_id: @verification.retailer_id, status: @verification.status }
    assert_redirected_to verification_path(assigns(:verification))
  end
